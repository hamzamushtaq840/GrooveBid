                ...
                <div className='max-w-[400px] mt-[27px] flex flex-col items-center w-full'>
                    ...
                    <form className='flex flex-col gap-[7px] w-full items-center' >
                        ...
                        <div className='flex justify-center'>
                            <button type="submit" className='buttonAnimation w-[7.5em] h-[2.3125em] mt-[9px] text-[0.875em] font-[700] bg-primary text-[#ffff] shadow-2xl rounded-[6px]' style={{ boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 6px 4px -1px rgba(0, 0, 0, 0.06)" }}>Sign in</button>
                        </div>
                    </form>
